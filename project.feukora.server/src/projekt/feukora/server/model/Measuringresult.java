...
public class Measuringresult implements Serializable{
	 ...
	 */
	public Measuringresult(Rapport rapportid, int position, int measuringgrade, int smokenumber, int carbonmonoxide, boolean oilpart, int nitrogendioxide, int exhaustgastemp, int heatertemp, int blowertemp, double oxygen, double exhaustgasloss){
