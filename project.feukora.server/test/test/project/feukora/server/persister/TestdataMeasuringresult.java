...
public class TestdataMeasuringresult {
	...
	private static final Logger logger = Logger
			.getLogger(TestdataMeasuringresult.class);
	...
	public static void loadTestdata() {
		...
		Rapport rap1 = new Rapport("LU", "Strasse 1", typ1, ch1, user1, app1, date1, true, false, "Kein Kommentar", true, true, true, true, true);
		Rapport rap2 = new Rapport("BE", "Road", typ2, ch2, user2, app2, date3, false, true, "Richtiger Kommentar", true, true, true, true, true);
